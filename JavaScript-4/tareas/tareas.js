...
const { forEach } = require("../../JavaScript-6/tareas/tareas");
...
function invocarMetodo(_objeto, metodo) {
...
function agregarMetodoCalculoDescuento(_producto) {
  ...
  // Tu código:
 _producto.calcularPrecioDescuento= function(){
    return  _producto.precio - (_producto.precio*_producto.porcentajeDeDescuento)
